...
public class DeleteGoalPage extends BrowserDriverUtil{
	
	Common_Library cmnLib = new Common_Library();
	private Logger log = Logger.getLogger(DeleteGoalPage.class.getName());
	...
	@FindBy(xpath="//label[contains(.,'Canceled')]")
	...
	public boolean SelectEmpReviewPeriod (String ReviewPeriod) throws Exception
	{
		...
		boolean found = false;
		List<WebElement> goalplan = getDriver().findElements(By.xpath("//ul[contains(@id,'_FOpt1:_FOr1:0:_FONSr2:0:MAnt2:1:goalUpl:UPsp1:rpdSel::pop')]/li"));
